...
<main class="site-main">
  ...
  <section class="market-band" aria-labelledby="market-heading"><div class="market-copy"><p class="kicker">DEEPSEEK HARNESS PLUGIN STORE</p><h2 id="market-heading">把分散在各处的好插件，收进一个可由 Agent 使用的 Store。</h2><p>deeplugin.store 聚合社区 Registry 和公开提交中的 DeepSeek Harness 插件，保留每个 Listing 的来源、版本与安装标识。人可以在这里浏览，Agent 可以搜索同一份注册表，并在你批准后完成安装和管理。</p><div class="market-outcomes"><span>来源可追溯</span><span>自然语言搜索</span><span>批准后安装</span></div><div class="market-links"><a class="button button-primary" href="#directory">Browse the Store</a><a class="button button-quiet" href="register.html">Register a plugin</a><a class="market-text-link" href="register-agent.html">Agent guide ↗</a><a class="market-text-link" href="data/market-registry.json">Registry JSON ↗</a></div></div><div class="market-install"><span>01 · INSTALL THE MARKET PLUGIN</span><code>dsh plugin --profile web add github:Shiyao-Huang/awesome-deepseek-harness-plugin#path:/plugin</code><button class="copy-install" type="button" data-install="dsh plugin --profile web add github:Shiyao-Huang/awesome-deepseek-harness-plugin#path:/plugin" aria-label="Copy market plugin install command">Copy</button><div class="market-install-footer"><small>安装一次并重启 DSH。之后直接告诉 Agent 你需要什么插件；任何写操作都会先请求你的批准。</small><a href="http://127.0.0.1:3080/">Open local DSH ↗</a></div></div></section>
