...
| 入口 | 为什么值得看 | 当前信号 |
| --- | --- | ---: |
| [官方核心 · DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) | DSH 的源头仓库；所有插件和能力最终回到这里核验。 | ★ stars 113,588 |
...
| Hacker News | [DeepSeek Harness developer preview](https://news.ycombinator.com/item?id=49285244) | points 728 · comments 305 | 开发者讨论 |
...
> 价值档当前分布：**A 1 · B 157 · C 1,000 · D 11,378**。分数只用于安排复核优先级；不同平台的 stars、likes、views、points 不相加，缺失互动数不补零。
...
| 来源 | 去重记录 | 采集内容 |
| --- | ---: | --- |
| GitHub | 12,197 | 官方仓库、topic、社区索引候选和 stars/forks/issues |
