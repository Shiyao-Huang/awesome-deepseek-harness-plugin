...
当前数据集版本：**v20260816T024149Z**，完成时间：**2026-08-16T02:41:49Z**。共 **12,961** 条去重记录，覆盖 **14** 个平台，外部媒体资产 **940** 条。
...
| core-and-ecosystem | 1,026 | 159 |
| ui-and-desktop | 230 | 4 |
| index-and-marketplace | 180 | 35 |
...
| github | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 76.22 | B | 100.00 | ui-and-desktop |
